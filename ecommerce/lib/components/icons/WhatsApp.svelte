...
<svg id="Layer_1" data-name="Layer 1"  class={cn("size-10", className)}
  viewBox="0 0 512 512">
  <defs>
    <style>
      .cls-1,
    ...
    <linearGradient id="linear-gradient" x1="1337.28" y1="518.24" x2="1337.28" y2="-2164.82"
      gradientTransform="matrix(0.19, 0, 0, -0.19, 0.81, 98.89)" gradientUnits="userSpaceOnUse">
