	...
	<div class="space-y-2">
		{#each items as item, index (item.id)}
			<div
				...
				class="flex items-center justify-between rounded-lg bg-white dark:bg-secondary p-4 shadow transition-all hover:shadow-md"
			>
				<button
				...
				<button
					class="ml-2 text-red-500 hover:text-red-700 interactive"
